...
import com.example.androidtut.QRScanner;
import com.google.android.gms.gcm.GoogleCloudMessaging;
import com.nusa.chris.Common;
import com.nusa.chris.DataProvider;
//import com.nusa.chris.MainActivity;
//import com.nusa.chris.R;
public class GcmBroadcastReceiver extends BroadcastReceiver {
	...
	private void sendNotification(String text, boolean launchApp) {
		...
		//may cause problem .setContentTitle(ctx.getString(R.string.app_name))
			.setContentText(text);
		...
		if (launchApp) {
			Intent intent = new Intent(ctx, QRScanner.class);
